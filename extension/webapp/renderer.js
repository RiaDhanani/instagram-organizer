...
window.IG.Renderer = (() => {
  ...
  const CANONICAL = {
    ...
    // Bars / Cocktails — all bar/drinks variants collapse to Chicago Bar or Cocktails
    'chicagobar': 'Chicago Bar', 'chicagococktails': 'Chicago Bar', 'chicagodrinks': 'Chicago Bar',
    'unknownbar': 'Chicago Bar', 'bar': 'Chicago Bar',
    'cocktailbar': 'Cocktails', 'cocktails': 'Cocktails', 'cocktail': 'Cocktails',
    'sipanddip': 'Chicago Bar', 'drinks': 'Chicago Bar',
